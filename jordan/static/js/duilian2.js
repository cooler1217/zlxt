...
function floaters() {
    ...
    this.addItem    = function(id,x,y,content)
    {
        ...
        div_obj.style.cssText="Z-INDEX: 9999; POSITION: absolute; background-color:red;  width:80px; height:60px;left:"+(typeof(x)=="string"?eval(x):x)+"px;top:"+(typeof(y)=="string"?eval(y):y)+"px";
