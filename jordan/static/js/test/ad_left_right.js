...
function floaters() {
    ...
    this.addItem    = function(id,x,y,content)
    {
        ...
        div_obj.style.cssText="Z-INDEX: 9999; POSITION: absolute; width:80px; height:60px;left:"+(typeof(x)=="string"?eval(x):x)+"px;top:"+(typeof(y)=="string"?eval(y):y)+"px";
...
function initAdvise(){
    ...
    theFloaters.addItem('show1',6,180,'<a href="http://www.fds321.com"><iframe style="width:100px;height:270px" frameborder=0 scrolling=no  src="http://127.0.0.1/jordan/god/test"></iframe></a><img src=http://42.121.126.86:9090/images/close.gif onClick="closeBanner();"/>');
